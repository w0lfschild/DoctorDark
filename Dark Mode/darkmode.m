...
#define APP_BLACKLIST @[@"com.apple.loginwindow", @"com.apple.iTunes", @"com.apple.Terminal",\
                        ...
                        @"org.kronenberg.WineBottler", @"com.cocoatech.PathFinder", @"com.github.GitHub",\
                        @"com.apple.ActivityMonitor", @"com.hnc.Discord", @"at.obdev.LaunchBar"]

#define APP_WHITELIST @[@"com.apple.finder", @"com.apple.systempreferences", @"com.apple.iChat", @"org.w0lf.mySIMBL"]
